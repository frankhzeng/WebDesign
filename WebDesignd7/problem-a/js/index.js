...
let parent = document.querySelector("#records");

function renderTrack(obj) {
  let image = document.createElement("img");
  image.src = obj.artworkUrl100;
  image.alt = obj.trackName + " by " + obj.artistName;
...
function fetchTrackList(search) {
  fetch("https://itunes.apple.com/search?limit=25&term=" + search)
...
searchButton.addEventListener("click", function() {
  let value = document.querySelector("#searchQuery").value;
  fetchTrackList(value);
})
