...
input.addEventListener("input", function(event) {
  ...
  if (age < 13) {
    ...
    input.setCustomValidity("You need to be at least 13");
    document.querySelector("#dobFeedback").textContent = "You need to be at least 13";
  } else {
...
function validatePasswordMatch() {
  let input1 = document.querySelector("#passwordInput");
  let input2 = document.querySelector("#passwordConfirmInput");
  console.log(input1.value + " || " + input2.value);
  if (!(input1.value === input2.value)) {
    console.log("no");
    input2.setCustomValidity("Passwords don't match");
    document.querySelector("#passwordConfirmFeedback").textContent = "Passwords don't match";
  } else {
